from PyQt5.QtWidgets import QWidget, QLineEdit, QVBoxLayout, QLabel, QDialog, QApplication, QTreeWidgetItem, QFontDialog, QMessageBox, QFrame, QSizePolicy, QColorDialog, QGridLayout, QStackedWidget, QPushButton, QVBoxLayout, QFileDialog, QScrollArea, QTreeWidget, QCheckBox
